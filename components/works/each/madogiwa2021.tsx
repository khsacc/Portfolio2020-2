  ...
  works: [
    {
      ...
      note:
        '本作は、教室の窓際のあたりに、入れ違いで何人かの登場人物がやってきて、なにげなく交わす会話が上演時間の大半を占めている。しかし、そういった具体的な内容をイメージさせるよりは、演出上大切にしたいと考えている解釈やメッセージを込めるという方針で作ることになった。込めようとしたものはいくつかあるが、「まなざしの交錯」は最も重要なテーマの一つである。登場人物間のみならず、観客と壇上とでも複雑な視線の絡み合いが起こることを期待している。',
    },
  ],
};
