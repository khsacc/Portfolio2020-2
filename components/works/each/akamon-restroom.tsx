...
export const akamonRestroom: NextPage = ({}) => (
  <>
    <p>
      ...
      は学内限定で開催された建築デザインコンペティションで、赤門のすぐそばにある5m×5mの小さな土地に多目的トイレをつくるというものだった。学園祭委員会時代からたくさんの共同制作をしてきた武田さんとこのコンペに参加することにした。建築デザインにきちんと取り組むのは人生で初めてだったが、ファイナリストまで進むことができた。自分自身が結果に驚いた。
    </p>
    <p>
    ...
    <p>
      建築系のソフトウェアの経験も知識もなく、正直なところ、設計も模型も提出物も稚拙さの残るものになってしまったと感じている。それでも空間デザインの感覚は新鮮で楽しく、学びが多かったし、それをコンペという場で評価してもらえたことは嬉しかった。足りないものを身に付けながら、次の機会を待とうと思う。
    </p>
  </>
);
