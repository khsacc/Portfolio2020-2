...
export const akamonRestroom: NextPage = ({}) => (
  <>
    <p>
      ...
      は学内限定で開催された建築デザインコンペティションで、赤門のすぐそばにある5m×5mの小さな土地に多目的トイレをつくるというものだった。共同制作者に建築を学んだことがある人はいなかったし、わたし自身建築デザインにきちんと取り組むのは人生で初めてだったが、最終審査のプレゼンテーションまで進むことができた。結果は応募総数121点中、次点の優秀賞。まず自分自身が結果に驚いた。
    </p>
    <p>
