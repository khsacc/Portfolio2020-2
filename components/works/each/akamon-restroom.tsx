...
export const akamonRestroom: NextPage = ({}) => (
  <>
    ...
    <p>
      建築系の知識もソフトウェアの経験もなく、正直なところ、設計も模型も提出物も稚拙さの残るものになってしまったと思う。それでも空間デザインの感覚は新鮮で楽しく、学びが多かったし、それをコンペという場で高く評価してもらえたことは嬉しかった。最終審査に残りつつ最優秀まであと一歩足りなかった、現地にこれを建てらなかったこの悔しさを忘れず、足りないものを身に付けながら、次の機会を待とうと思う。
    </p>
  </>
);
