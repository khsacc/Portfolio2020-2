...
export const akamonRestroom: NextPage = ({}) => (
  <>
    <p>
      ...
      は学内限定で開催された建築デザインコンペティションで、赤門のすぐそばにある5m×5mの小さな土地に多目的トイレをつくるというものだった。共同制作者に建築を学んだことがある人はいなかったし、わたし自身建築デザインにきちんと取り組むのは人生で初めてだったが、最終審査のプレゼンテーションまで進むことができた。
    </p>
    <p>
    ...
    <p>
      建築系の知識もソフトウェアの経験もなく、正直なところ、設計も模型も提出物も稚拙さの残るものになってしまったと感じている。それでも空間デザインの感覚は新鮮で楽しく、学びが多かったし、それをコンペという場で高く評価してもらえたことは嬉しかった。最終審査に残りつつ最優秀まであと一歩足りなかった悔しさを忘れず、足りないものを身に付けながら、次の機会を待とうと思う。
    </p>
  </>
);
